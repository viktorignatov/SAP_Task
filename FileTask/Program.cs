...
List<List<int>> ReadAndValidateFile(string path)
{
...
void DisplayFile(List<List<int>> content)
{
...
void SwapLines(List<List<int>> content, int index1, int index2)
{
    ...
    List<int> temp = content[index1];
    content[index1] = content[index2];
    content[index2] = temp;
}

void SwapNumbers(List<List<int>> content, int x1, int y1, int x2, int y2)
{
    ...
    int temp = content[x1][y1];
    content[x1][y1] = content[x2][y2];
    content[x2][y2] = temp;
}

void ReverseLine(List<List<int>> content, int lineIndex)
{
...
void ReverseAllNumbers(List<List<int>> content)
{
...
void SaveToFile(List<List<int>> content, string path)
{
...
while (true)
{
    ...
    switch (choice)
    {
        ...
        case 2:
            ...
            SwapNumbers(fileContent, lines[0], lines[1], lines[2], lines[3]);
            break;
